...
os.system('brew cask install google-chrome sublime-merge visual-studio-code spotify slack vlc zoom')
...
print "Dracula Theme will be downloaded to Desktop, select it later from iTerm profile settings"
