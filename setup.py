...
os.system('brew install --cask homebrew/cask-versions/adoptopenjdk8')
os.system('brew install openjdk')
os.system('sudo ln -sfn /usr/local/opt/openjdk/libexec/openjdk.jdk /Library/Java/JavaVirtualMachines/openjdk.jdk')
